...
// Called every frame
void UNSInteractionComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UNSInteractionComponent::PrimaryInteract()
{
	...
	for (FHitResult Hit : Hits)
	{
		...
		if (HitActor)
		{
			...
			if (HitActor->Implements<UNSGameplayInterface>())
			{
				INSGameplayInterface::Execute_Interact(HitActor, MyPawn);
				break;
			}
		}
